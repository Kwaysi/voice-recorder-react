...
var Recorder = /** @class */ (function (_super) {
    ...
    function Recorder(props) {
        ...
        _this.handleReset = function (e) {
            ...
            _this.setState({
                ...
                _this.props.handleReset(_this.state);
            });
        };
        _this.state = {
            time: {
    ...
    Recorder.prototype.countDown = function () {
        ...
        this.setState({
            ...
            seconds: seconds,
        }, function () { return _this.props.getTime(_this.state.time); });
    };
