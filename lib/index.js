...
var Recorder = /** @class */ (function (_super) {
    ...
    function Recorder(props) {
        ...
        _this.handleAudioPause = function () {
            ...
            _this.setState(__assign(__assign({}, _this.state), { pauseRecord: true }));
        };
        _this.handleAudioStart = function () {
            _this.startTimer();
            _this.mediaRecorder.resume();
            _this.setState(__assign(__assign({}, _this.state), { pauseRecord: false }));
        };
        _this.startRecording = function () {
            ...
            _this.setState(__assign(__assign({}, _this.state), { recording: true }));
        };
        _this.stopRecording = function () {
            clearInterval(_this.timer);
            _this.setState(__assign(__assign({}, _this.state), { seconds: 0, time: _this.initialTime }));
            // stop the recorder
            _this.mediaRecorder.stop();
            // say that we're not recording
            _this.setState(__assign(__assign({}, _this.state), { recording: false, pauseRecord: false }));
        ...
        _this.handleReset = function () {
            ...
            _this.setState(__assign(__assign({}, _this.state), { seconds: 0, audios: [], recording: false, medianotFound: false, time: _this.initialTime, audioBlob: _this.emptyBlob }), function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 3];
                    case 2:
                        this.setState(__assign(__assign({}, this.state), { medianotFound: true }));
                        _a.label = 3;
    ...
    Recorder.prototype.countDown = function () {
        ...
        this.setState(__assign(__assign({}, this.state), { seconds: seconds, time: this.secondsToTime(seconds) }));
    };
    ...
    Recorder.prototype.saveAudio = function () {
        ...
        this.setState(__assign(__assign({}, this.state), { audioData: {
                blob: blob,
                url: audioURL,
                chunks: this.chunks,
